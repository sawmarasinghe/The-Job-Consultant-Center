                ...
                <div class="height-100 bg-light">
                    <div class="container">
                        ...
                        <div class="container text-left">
                            <a href="<%=request.getContextPath()%>/UsersServlet?action=addUserFrm"
                                ...
                                <c:forEach var="User" items="${usersList}">
                                    <tr>
                                        ...
                                        <td><a class="btn btn-primary"
                                                href="UsersServlet?action=updateFrm&id=<c:out value='${User.getUser_ID()}' />">Edit</a>
                                            &nbsp;&nbsp;&nbsp;&nbsp; <a class="btn btn-danger"
                                                href="DeleteUserServlet?id=<c:out value='${User.getUser_ID()}' />">Delete</a>
                                        </td>
                                    </tr>
                                </c:forEach>
                                <!-- } -->
